 ...
 * </p>
 * <ul>
 *   <li>{@link dsm.PROVE.impl.ArtifactStateInstanceImpl#getUsedByActivity <em>Used By Activity</em>}</li>
 *   <li>{@link dsm.PROVE.impl.ArtifactStateInstanceImpl#getOriginatingActivity <em>Originating Activity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArtifactStateInstanceImpl extends MinimalEObjectImpl.Container implements ArtifactStateInstance {
	 ...
	 * @ordered
	 */
	protected dsm.PROVE.Process usedByActivity;
	 ...
	 * @ordered
	 */
	protected dsm.PROVE.Process originatingActivity;
	 ...
	 * @generated
	 */
	public dsm.PROVE.Process basicGetUsedByActivity() {
		return usedByActivity;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetUsedByActivity(dsm.PROVE.Process newUsedByActivity, NotificationChain msgs) {
		dsm.PROVE.Process oldUsedByActivity = usedByActivity;
	 ...
	 */
	@Override
	public void setUsedByActivity(dsm.PROVE.Process newUsedByActivity) {
		if (newUsedByActivity != usedByActivity) {
			NotificationChain msgs = null;
			if (usedByActivity != null)
				msgs = ((InternalEObject) usedByActivity).eInverseRemove(this,
						PROVEPackage.PROCESS__ARTIFACT_IN_STATE_USED, dsm.PROVE.Process.class, msgs);
	 ...
	 */
	@Override
	public dsm.PROVE.Process getOriginatingActivity() {
		if (originatingActivity != null && originatingActivity.eIsProxy()) {
			...
			originatingActivity = (dsm.PROVE.Process) eResolveProxy(oldOriginatingActivity);
	 ...
	 * @generated
	 */
	public dsm.PROVE.Process basicGetOriginatingActivity() {
		return originatingActivity;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOriginatingActivity(dsm.PROVE.Process newOriginatingActivity,
			NotificationChain msgs) {
		dsm.PROVE.Process oldOriginatingActivity = originatingActivity;
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case PROVEPackage.ARTIFACT_STATE_INSTANCE__USED_BY_ACTIVITY:
			if (usedByActivity != null)
				msgs = ((InternalEObject) usedByActivity).eInverseRemove(this,
						PROVEPackage.PROCESS__ARTIFACT_IN_STATE_USED, dsm.PROVE.Process.class, msgs);
			return basicSetUsedByActivity((dsm.PROVE.Process) otherEnd, msgs);
		case PROVEPackage.ARTIFACT_STATE_INSTANCE__ORIGINATING_ACTIVITY:
			if (originatingActivity != null)
				msgs = ((InternalEObject) originatingActivity).eInverseRemove(this,
						PROVEPackage.PROCESS__RESULT_ARTIFACT_IN_STATE, dsm.PROVE.Process.class, msgs);
			return basicSetOriginatingActivity((dsm.PROVE.Process) otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case PROVEPackage.ARTIFACT_STATE_INSTANCE__USED_BY_ACTIVITY:
			setUsedByActivity((dsm.PROVE.Process) newValue);
			return;
		case PROVEPackage.ARTIFACT_STATE_INSTANCE__ORIGINATING_ACTIVITY:
			setOriginatingActivity((dsm.PROVE.Process) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case PROVEPackage.ARTIFACT_STATE_INSTANCE__USED_BY_ACTIVITY:
			setUsedByActivity((dsm.PROVE.Process) null);
			return;
		case PROVEPackage.ARTIFACT_STATE_INSTANCE__ORIGINATING_ACTIVITY:
			setOriginatingActivity((dsm.PROVE.Process) null);
			return;
		}
